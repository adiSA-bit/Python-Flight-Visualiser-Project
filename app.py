...
for flight in flight_data:
    ...
    location1 = [lat1, lon1]
    folium.Marker(location=location1,popup=f"Flight: {flight['flight_number']}",icon=folium.Icon(color="green", icon="plane", prefix="fa")).add_to(flight_map)

    lat2 = flight["route"][-1]["latitude"]
    lon2 = flight["route"][-1]["longitude"]
    location2 = [lat2, lon2]
    folium.Marker(location=location2,popup=f"Flight: {flight['flight_number']}",icon=folium.Icon(color="blue", icon="plane", prefix="fa")).add_to(flight_map)
